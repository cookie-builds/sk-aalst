        ...
        <div class="flex flex-col md:flex-row gap-4 bg-yellow-50 shadow-md p-4" v-for="club of clubs">
          ...
          <div class="flex flex-col align-top gap-2">
            ...
            <div class="inline-flex ml-auto">
              <a v-if="club.facebook" :href="club.facebook" :class="`bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 ${club.website ? 'rounded-l' : 'rounded'}`">
                Naar Facebook
              </a>
              <a v-if="club.website" :href="club.website" :class="`bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 ${club.facebook ? 'rounded-r' : 'rounded'}`">
                Naar Website
              </a>
            </div>
          </div>
